...
for (const usersElement of usersList) {
    let userArray = document.createElement('div');

    let idUser = document.createElement('div');
    idUser.innerText = usersElement.id;
    let nameUser = document.createElement('h2');
    nameUser.innerText = usersElement.name;
    let userNameUsers = document.createElement('div');
    userNameUsers.innerText = usersElement.username;
