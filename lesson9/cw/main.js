...
//     divSimpsons.innerText = `${simpson.name}   ${simpson.surname}`
...
//
//     let imgSimpsons = document.createElement('img');
//     imgSimpsons.src = simpson.photo
//
//     divElement.append(divName, divSurname, divAge, pInfo, imgSimpsons);
...
for (const course of coursesArray) {
    ...
    courseElement.append(titleElement, modulesElement, hourDurationElement, monthDurationElement);
