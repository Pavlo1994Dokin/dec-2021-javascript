...
for (let i = 0; i < users.length; i++) {
    ...
    document.write(`<div class="address_block">`);
    document.write(`<p>City - ${user.address.city} Street - ${user.address.street} Suite - ${user.address.suite} Zip code - ${user.address.zipcode}</p>`);
    document.write(`</div>`);
    document.write(`</div>`);
}
