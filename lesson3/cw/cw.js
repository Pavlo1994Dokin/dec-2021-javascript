...
//     document.write(`<li class="wrap">${simpson.name} ${simpson.surname} ${simpson.age} ${simpson.info},  <img src="${simpson.photo}" alt=""></li>`)
// }
//
//     document.write('</div>');
...
//     document.write(`<h2 class="title">${simpson.name} ${simpson.surname} age is ${simpson.age}</h2>`);
//     document.write(`<p class="txt"> ${simpson.info}</p>`);
...
//     document.write(`<img src="${product.image}" alt="" class="product_img">`);
// }
// document.write(`</div>`);
